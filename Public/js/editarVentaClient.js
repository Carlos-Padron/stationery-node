window.addEventListener("DOMContentLoaded", () => {
  ...
  async function updateSale(saleInfo) {
    try {
      disableButton(
        registerSaleBtn,
        "Actualizando Venta",
  ...
  function registerSaleBtnClick() {
    ...
    registerSaleUpdateConfirmation(response.body);
  }

  function registerSaleUpdateConfirmation(saleInfo) {
    confirmationAlert("Se actualizará la venta", () => {
      updateSale(saleInfo);
    });
  }
